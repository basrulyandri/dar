...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{asset('assets/metronic')}}/global/plugins/toastr/toastr.min.css" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="{{asset('assets/metronic')}}/global/plugins/sweetalert/sweetalert.css">
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="{{asset('assets/metronic')}}/layouts/layout4/img/logo-light.png" alt="logo" class="logo-default" /> </a>
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="true">
                                    ...
                                    <img alt="" class="img-circle" src="{{auth()->user()->getAvatarUrl()}}"> </a>
                            ...
                            <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                ...
                                <ul class="media-list list-items">
                                    <li class="media">
                                        ...
                                        <img class="media-object" src="{{asset('assets/metronic')}}/layouts/layout/img/avatar3.jpg" alt="...">
                                    ...
                                    <li class="media">
                                        <img class="media-object" src="{{asset('assets/metronic')}}/layouts/layout/img/avatar1.jpg" alt="...">
                                        <div class="media-body">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2018 &copy; {{config('app.name')}} by 
                <a target="_blank" href="http://rolloic.com">Basrul Yandri</a>              
            </div>
...
<![endif]-->
        ...
        <script src="{{asset('assets/metronic')}}/global/plugins/sweetalert/sweetalert.min.js"></script>
