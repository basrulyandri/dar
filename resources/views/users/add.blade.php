    ...
    <div class="col-lg-6">
      <div class="portlet light bordered">        
        <div class="portlet-body form">
            {!!Form::open(['route' =>'user.create','enctype' => 'multipart/form-data'])!!}
                <div class="form-body">
        ...
        <div class="portlet-body form">
                <div class="form-body">                    
                    ...
                    <div class='form-group form-md-line-input form-md-floating-label{{$errors->has('google_plus_url') ? ' has-error' : ''}}'>                      
                        {!!Form::text('google_plus_url',old('google_plus_url'),['class' => 'form-control'])!!}
                    ...
                    <div class="form-group form-md-checkboxes">                                           
                        <div class="md-checkbox-list">
                            <div class="md-checkbox">
                                <input type="checkbox" id="sendEmail" name="sendEmail" class="md-check">
                                <label for="sendEmail">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span> Send email registration detail to this user 
                                </label>
                            </div>                                               
                        </div>
                    </div>
